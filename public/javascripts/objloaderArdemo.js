function init() {
    ...
    loader.load('/images/arDemo/models/head/lee-perry-smith-head-scan.obj', function (object) {
        var colorMap = textureLoader.load('/images/arDemo/models/head/Face_Color.jpg');
        var bumpMap = textureLoader.load('/images/arDemo/models/head/Face_Disp.jpg');
